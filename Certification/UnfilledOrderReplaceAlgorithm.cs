...
namespace QuantConnect.Atreyu.Certification
{
    /// <summary>
    /// D6 - Unfilled order
    /// replace request issued to increase order qty accepted
    /// </summary>
    /// <meta name="tag" content="using data" />
    /// <meta name="tag" content="using quantconnect" />
    /// <meta name="tag" content="trading and orders" />
    public class UnfilledOrderReplaceAlgorithm : BaseAtreyuCertificationTestAlgorithm
    {
        protected override string TestCode { get; } = "D6";
        ...
        public override void OnOrderSubmitted(OrderEvent orderEvent)
        {
            Executions[orderEvent.Symbol.Value].Executions = new Queue<ExecutionEvent>(new[]
            {
                ...
                new ExecutionEvent {Status = OrderStatus.PartiallyFilled, FillQuantity = 36},
                new ExecutionEvent {Status = OrderStatus.PartiallyFilled, FillQuantity = 36},
                new ExecutionEvent {Status = OrderStatus.Filled, FillQuantity = 38}
            });
        }
    }
}
