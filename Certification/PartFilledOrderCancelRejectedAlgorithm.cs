...
namespace QuantConnect.Atreyu.Certification
{
    ...
    public class PartFilledOrderCancelRejectedAlgorithm : BaseAtreyuCertificationTestAlgorithm
    {
        protected override string TestCode { get; } = "D4a";
        ...
        public override void OnOrderSubmitted(OrderEvent orderEvent)
        {
            Executions[orderEvent.Symbol.Value].Executions = new Queue<ExecutionEvent>(new[]
            {
                ...
                new ExecutionEvent {Status = OrderStatus.Filled, FillQuantity = 25}
            });
        }
