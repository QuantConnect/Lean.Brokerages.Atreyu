...
{
    /// <summary>
    /// D11 - Cancel/Replace request on open order
    /// The requested order qty equals the cum qty.
    /// Order qty is amended to cum qty
    /// </summary>
    /// <meta name="tag" content="using data" />
    /// <meta name="tag" content="using quantconnect" />
    /// <meta name="tag" content="trading and orders" />
    public class FilledOrderReplaceAmendedCumQtyAlgorithm : BaseAtreyuCertificationTestAlgorithm
    {
        protected override string TestCode { get; } = "D11";
        ...
        public override void OnOrderSubmitted(OrderEvent orderEvent)
        {
            ...
            {
                new ExecutionEvent {Status = OrderStatus.PartiallyFilled, FillQuantity = 70},
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                if (exec.Ticket.QuantityFilled != 70)
                {
                    throw new Exception($"Filled Quantity {exec.Ticket.QuantityFilled}; expected 70.");
                }
            }
        }
    }
