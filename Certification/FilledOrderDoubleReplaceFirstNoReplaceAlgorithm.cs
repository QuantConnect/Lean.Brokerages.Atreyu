...
namespace QuantConnect.Atreyu.Certification
{
    /// <summary>
    /// D14
    /// First cancel/replace request is rejected after pending replace -
    /// second cancel/replace is accepted
    /// </summary>
    /// <meta name="tag" content="using data" />
    /// <meta name="tag" content="using quantconnect" />
    /// <meta name="tag" content="trading and orders" />
    public class FilledOrderDoubleReplaceFirstNoReplaceAlgorithm : BaseAtreyuCertificationTestAlgorithm
    {
        protected override string TestCode { get; } = "D15";
