...
{
    /// <summary>
    /// D7b - Partially filled order,
    /// followed by cancel/replace request to increase order qty
    /// execution occurs whilst order is pending replace
    /// replace rejected, no pending issued
    /// </summary>
    /// <meta name="tag" content="using data" />
    /// <meta name="tag" content="using quantconnect" />
    /// <meta name="tag" content="trading and orders" />
    public class PartFilledOrderReplaceNoPendingAlgorithm : BaseAtreyuCertificationTestAlgorithm
    {
        protected override string TestCode { get; } = "D7b";
