...
{
    /// <summary>
    /// D12 - Cancel/Replace request on open order
    /// The requested order qty is below cum qty.
    /// Order qty is amended to cum qty
    /// </summary>
    /// <meta name="tag" content="using data" />
    /// <meta name="tag" content="using quantconnect" />
    /// <meta name="tag" content="trading and orders" />
    public class FilledOrderReplaceBelowCumQtyAmendedAlgorithm : BaseAtreyuCertificationTestAlgorithm
    {
        protected override string TestCode { get; } = "D12";
        ...
        public override void OnOrderSubmitted(OrderEvent orderEvent)
        {
            ...
            {
                new ExecutionEvent {Status = OrderStatus.PartiallyFilled, FillQuantity = 85},
        ...
        public override void OnEndOfAlgorithm()
        {
            ...
            {
                if (exec.Ticket.QuantityFilled != 85)
                {
                    throw new Exception($"Filled Quantity {exec.Ticket.QuantityFilled}; expected 85.");
                }
            }
        }
    }
